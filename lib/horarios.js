...
// trabalha nesse dia). O passo continua GRANULARIDADE_MIN.
export function gerarSlotsDaJanela(janela, duracaoMin = DURACAO_MINUTOS) {
  ...
  const slots = [];
  for (let m = inicio; m + duracao <= fim; m += GRANULARIDADE_MIN) {
