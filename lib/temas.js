...
const TEMAS_POR_SLUG = {
  laysla: {
    ...
    layoutMarca: "centro",
    ocultarNome: true,
    // Altura REAL do lockup (sem escalaLogo: scale() encolhia só o visual e
    // deixava o espaço de layout ocupando o header). A arte já traz ~15%/11%
    // de margem transparente em cima/embaixo, por isso o headerPy é mínimo.
    ...
    alturaMonograma: "h-20 w-auto object-contain sm:h-24",
    ...
    headerCompacto: true,
    // Header afinado (mesmo mecanismo da layra, ver Hero.js). min-h =
    // logo + py exatos (80+8 / 96+8), sem sobra; calibrado no browser.
