...
acolhe: {
  ...
  avisoTopo: "Agendamento fictício de demonstração — nenhum atendimento será realizado.",
},
  julia: {
    personalizado: true,
    bgHeader: "#FBF3F0",
    ...
    botaoHover: "#762727",
    fonteDisplay: "font-cormorant",
    marca: "/images/julia/julia-logo.png",
    layoutMarca: "esquerda",
    headerCompacto: true,
    nomeExibido: "Julia\u00A0Koenigkam Nails",
    tamanhoNome: "text-[26px] sm:text-[32px] leading-tight max-w-full",
    alturaMonograma: "h-28 w-auto sm:h-32",
  },
