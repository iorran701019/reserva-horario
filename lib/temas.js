...
acolhe: {
  ...
  julia: {
    ...
    botaoHover: "#8A6F38",
    fonteDisplay: "font-cormorant",
    // Monograma "JK" recortado do logo novo, fundo transparente (o nome segue
    // em texto ao lado, centralizado junto com a logo).
    marca: "/images/julia/julia-jk.png",
    layoutMarca: "centro",
    headerCompacto: true,
    nomeExibido: "Julia\u00A0Koenigkam Nails",
    tamanhoNome: "text-[22px] sm:text-[28px] leading-tight max-w-full",
    // Refer\u00EAncia: monograma da Laysla (h-16/sm:h-20 \u00D7 escalaMonograma 0.65 \u2248
    // 42/52px). O JK \u00E9 linha fina, ent\u00E3o fica um pouco maior.
    alturaMonograma: "h-14 w-auto sm:h-16",
  },
