...
const TEMAS_POR_SLUG = {
  laysla: {
    ...
    personalizado: true,
    // Atualizado a pedido da cliente para #B5B5B5 (substitui o #DFDFDF da
    // Variação D aprovada antes). Mais escuro que o bgBody (#CDCDCD, abaixo)
    // — inverte a ordem de camadas que a Variação D tinha (header mais claro
    // que o body); ver bordaHeader/bgBody logo abaixo.
    bgHeader: "#B5B5B5",
