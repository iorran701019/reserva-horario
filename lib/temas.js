...
acolhe: {
  ...
  julia: {
    ...
    // recomposto sem margens, fundo transparente (890x315, ~2.8:1). O nome já
    // vem na imagem, então ocultarNome evita duplicar.
    marca: "/images/julia/julia-lockup.png",
    layoutMarca: "centro",
    headerCompacto: true,
    nomeExibido: "Julia Koenigkam Nails",
    ocultarNome: true,
    // Altura recalculada pro formato largo: h-20 (80px) => ~226px de largura
    // no mobile; sm:h-24 (96px) => ~271px.
    alturaMonograma: "h-20 w-auto sm:h-24",
  },
