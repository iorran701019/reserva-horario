...
export function useConflitoWhatsapp() {
  ...
  function confirmarConflito(onIdentificado, telefoneExibido) {
    onIdentificado({
      ...
      clienteNovo: false,
      // Mesmo formato dos demais caminhos de identificação: o cliente vem de
      // cliente_buscar_por_whatsapp, que já devolve etiqueta_id. Sem esta
      // linha, quem entrasse pelo modal de conflito perderia a etiqueta e
      // veria os dias restritos cinzas (ver diaLiberadoPorEtiqueta).
      etiqueta_id: clienteConflitante.etiqueta_id ?? null,
    });
