...
import { hidratarAbacatepayConectado } from "@/lib/estabelecimento";
...
export async function buscarPerfil() {
  ...
  // Pendentes. A hidratação de `abacatepay_conectado` é a MESMA função do
  // outro loader, nunca uma segunda implementação.
  return {
    papel: data.papel,
    estabelecimento: await hidratarAbacatepayConectado(data.estabelecimentos ?? null),
  };
}
